...
const CHART_TYPES = {
	line: {
		component: Line, icon: <FontAwesomeIcon icon='fa-duotone fa-chart-line' />, name: 'Line'
	},
	bar: { component: Bar, icon: <FontAwesomeIcon icon='fa-duotone fa-chart-column' />, name: 'Bar' },
	doughnut: { component: Doughnut, icon: <FontAwesomeIcon icon='fa-duotone fa-donut' />, name: 'Doughnut' },
};
...
const ContributionChart = ({ contributionCollection }) => {
	...
	const [selectedChartType, setSelectedChartType] = useState(DEFAULT_CHART_TYPE);
	...
	return (
		<div className="flex flex-col gap-4 rounded-box p-4 border border-base-300 bg-base-100">
			...
			{/* Chart Container */}
			<div className="bg-base-50 rounded-lg p-4" style={{ height: '300px', width: '100%' }}>
				{chartData ? (
					<ChartComponent
