...
const SinglePostContent = ({ post }) => {
	...
	return (
		<div className="container flex flex-col gap-4 py-12 mt-16">
			...
			<article className="container bg-base-100 text-base-content rounded-box py-8">
				<div className="max-w-4xl mx-auto px-4">
					...
					<header className="mb-8 text-center">
						...
						<time className="text-base-content/70 text-lg" dateTime={post.created_at}>
							{createdAtText}
						</time>
					</header>
					...
					{/* Description */}
					<div className="mb-8">
						<p className="text-lg leading-relaxed text-base-content/80 font-medium border-b border-base-300 pb-6">
							{post.description}
						</p>
					</div>
					...
					<div className="flex flex-wrap items-center gap-2 mb-12">
						<h5 className="font-semibold text-base-content">Tags:</h5>
					...
					<nav className="grid grid-cols-1 md:grid-cols-2 gap-6">
						{post.prev && (
							...
							>
								<div className="card-body">
									<div className="text-sm text-base-content/60 mb-2">← Older Post</div>
						...
						{post.next && (
							...
							>
								<div className="card-body">
									<div className="text-sm text-base-content/60 mb-2">Newer Post →</div>
