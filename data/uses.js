...
export const USES = {
	...
	DevTools: [
		...
		{
			name: 'Catppuccin',
			metadata: 'Soothing Pastel Coding Theme',
			href: 'https://catppuccin.com/',
			id: 'minhtran-catppuccin',
			image: '/uses/coding/catppuccin.png',
		},
		{
		...
		{
			name: 'Ghostty',
			metadata: 'Terminal with GPU Acceleration',
			href: 'https://www.ghostty.com',
			id: 'minhtran-ghostty',
			image: '/uses/coding/ghostty.png',
		},
		{
			name: 'Oh My Zsh',
			metadata: 'Zsh Configuration Framework',
			href: 'https://ohmyz.sh/',
			id: 'minhtran-ohmyzsh',
		...
		{
			name: 'Insomnia',
			metadata: 'API Collaboration Platform',
			href: 'https://insomnia.rest/',
			id: 'minhtran-insomnia',
			image: '/uses/coding/insomnia.png',
		},
		{
			name: 'Cloudflare',
	...
	Softwares: [
		...
		},
		{
			...
			id: 'minhtran-chrome',
			image: '/uses/softwares/chrome.png',
		},
		{
			name: 'Spotify',
		...
		},
		{
			...
			id: 'minhtran-motrix',
			image: '/uses/softwares/motrix.png',
		},
		{
			name: 'Raycast',
			metadata: 'Productivity Tool',
			href: 'https://www.raycast.com/',
			id: 'minhtran-raycast',
			image: '/uses/softwares/raycast.png',
		},
		{
			name: 'QuickTime Player',
			metadata: 'Media Player',
			href: 'https://www.apple.com/quicktime/',
			id: 'minhtran-quicktime',
			image: '/uses/softwares/quicktime.png',
		}
	],
};
